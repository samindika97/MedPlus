...
const Home = () => {
  return (
    <div className="">
      <div className="my-5 flex h-96 justify-between">
        <div className="flex w-1/2 flex-col items-start justify-center">
          <p className="text-blue text-5xl font-bold">
            Lorem ipsum dolor sit amet,{" "}
            <span className="text-cyan">consectetur adipiscing</span> elit.
          </p>
          <p className="text-blue mt-3 w-4/5 text-sm">
          ...
          <button className="bg-cyan mt-3 rounded-3xl px-4 py-1">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-cyan relative h-24 w-full rounded-xl p-5">
          <img
            src={SymptomCheckerImg}
