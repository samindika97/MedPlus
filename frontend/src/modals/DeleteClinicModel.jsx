...
export default function MyModal({deleteClinic, isOpen, closeModal, openModal , fetchInfo}) {

  function handleDelete(clinicId) {
    console.log("id:",clinicId);
    const axiosConfig = {
      method: "delete",
      url: `${BASE_URL}clinic/${clinicId}`,
    };
    console.log(`${BASE_URL}clinic/${clinicId}`);
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure want to delete Clinic :
                    </p>
                  </div>
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      onClick={()=>{handleDelete(deleteClinic)}}
                    >
